...
Figure~\ref{fig.noise1} shows the result.  The spectrum looks pretty
random, too.  And it is, but we have to be more precise about the
word ``random.''  There are at least three things we might like to
know about a random signal, or its spectrum:
