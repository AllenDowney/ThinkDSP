...
\begin{figure}
% noise.py
\centerline{\includegraphics[height=2.5in]{figs/noise0.pdf}}
...
\begin{figure}
% noise.py
\centerline{\includegraphics[height=2.5in]{figs/noise2.pdf}}
...
\begin{figure}
% noise.py
\centerline{\includegraphics[height=2.5in]{figs/noise3.pdf}}
\caption{?}
\label{fig.noise3}
\end{figure}
...
distribution.  If you are not familiar with CDFs, you might want
to read Appendix~\ref{}, which is an exerpt from {\it Think Stats}
that explains CDFs.  It also presents methods to test whether a
particular distribution is a good model for a set of data.
