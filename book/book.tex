...
Section~\ref{brownian}).  And the spectrum looks like a straight
line, albeit a noisy one.  The estimated slope of the spectrum is -1.9,
...
and the estimated parameter, -0.06, is near zero, which is what
...
window_wave = thinkdsp.Wave(padded, framerate=close.framerate)
...
\caption{The DFT of the finite difference window.}
\label{fig.diff_int3}
\end{figure}
...
For signals with more than one component,
